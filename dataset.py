...
dataset_dpo = load_dataset("json", data_files='./memory_dpo_train.json')
...
split_dataset_1.save_to_disk('./Dolphin_Task1')
split_dataset_2.save_to_disk('./Dolphin_Task2')
split_dataset_3.save_to_disk('./Dolphin_Task3')