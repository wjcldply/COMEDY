...
class RewardModel(nn.Module):
    ...
    def __init__(self, base_model, tokenizer, num_padding_at_beginning=0):
        ...
        # self.rwtranrsformer = base_model.base_model # for xllm3
        # self.rwtranrsformer = base_model.base_model.model # for ziya-7B-rw
        self.rwtranrsformer = base_model.model  # for llama
        # self.v_head = base_model.score # for xllm2-shenyang-rw
        self.v_head = nn.Linear(
            self.config.hidden_size, 1, bias=False
        )  # for any sft model
        # self.v_head = base_model.value_head # for ziya-7B-rw
    ...
    def forward(
        ...
        for i in range(bs):
            ...
            )  # use the end score for refrnence
