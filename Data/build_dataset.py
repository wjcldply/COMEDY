...
split_dataset_1['validation'].to_json('./MultiTask_Training_Data/Dolphin_Task1_validation.json')
...
split_dataset_2['validation'].to_json('./MultiTask_Training_Data/Dolphin_Task2_validation.json')
...
split_dataset_3['validation'].to_json('./MultiTask_Training_Data/Dolphin_Task3_validation.json')
split_multitask_dataset.save_to_disk('./MultiTask_Training_Data/Dolphin_MultiTask')
split_multitask_dataset['train'].to_json('./MultiTask_Training_Data/Dolphin_MultiTask_train.json')
split_multitask_dataset['validation'].to_json('./MultiTask_Training_Data/Dolphin_MultiTask_validation.json')
split_shuffled_multitask_dataset.save_to_disk('./MultiTask_Training_Data/Dolphin_MultiTask_Shuffled')
split_shuffled_multitask_dataset['train'].to_json('./MultiTask_Training_Data/Dolphin_MultiTask_Shuffled_train.json')
split_shuffled_multitask_dataset['validation'].to_json('./MultiTask_Training_Data/Dolphin_MultiTask_Shuffled_validation.json')
